...
import com.icefire.chnsmile.ui.dialog.ViewHelper;

import jp.wasabeef.glide.transformations.BlurTransformation;
import jp.wasabeef.glide.transformations.RoundedCornersTransformation;

public class HawImageView extends AppCompatImageView {
    public HawImageView(Context context) {
        super(context);
    }

    public HawImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HawImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        ViewHelper.setViewOutline(this, attrs, defStyleAttr, 0);
    }

    public void setImagePath(int resId) {
        RequestBuilder<Drawable> builder = Glide.with(this).load(resId);
        builder.into(this);
    }
    ...
    public static void setImageUrl(HawImageView view, String imageUrl) {
        view.setImageUrl(view, imageUrl, false, 0);
    }

    @BindingAdapter(value = {"image_url", "isCircle"})
    public static void setImageUrl(HawImageView view, String imageUrl, boolean isCircle) {
        view.setImageUrl(view, imageUrl, isCircle, 0);
    }

    @BindingAdapter(value = {"image_url", "isCircle", "radius"}, requireAll = false)
    public static void setImageUrl(HawImageView view, String imageUrl, boolean isCircle, int radius) {
