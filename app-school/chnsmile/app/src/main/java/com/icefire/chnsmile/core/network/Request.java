...
import com.icefire.chnsmile.core.network.cache.CacheManager;
...
public abstract class Request<T, R extends Request> implements Cloneable {
    ...
    public R addParam(Object object) {
        if (object instanceof JSONObject) {
            Map<String, Object> maps = JSONObject.toJavaObject((JSONObject) object, Map.class);
        ...
        try {
            ...
            if (success) {
                ...
                if (callback != null) {
                    ...
                    map = convert.convert(content, argument);
                    code = (int) map.get("code");
                    message = (String) map.get("message");
                    result.body = (T) map.get("data");
                } else if (mType != null) {
                    map = convert.convert(content, mType);
                    code = (int) map.get("code");
                    message = (String) map.get("message");
                    result.body = (T) map.get("data");
                }
