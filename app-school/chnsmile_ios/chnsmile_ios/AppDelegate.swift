...
class AppDelegate: UIResponder, UIApplicationDelegate, GeTuiSdkDelegate {
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        WXApi.handleOpen(url, delegate: WXUtils.shared)
        return true
    }
    ...
    func application(_ application: UIApplication, continue userActivity:
        ...
        return WXApi.handleOpenUniversalLink(userActivity, delegate: WXUtils.shared)
    }
...
//        }
    ...
    /// 跳转到绑定微信账号
    func toWxBd() {
//        setRootViewController(name: "wxbd", isNav: true)
        let mainStory = UIStoryboard(name: "Main", bundle: nil)
        let controller = mainStory.instantiateViewController(withIdentifier: "wxbd")
