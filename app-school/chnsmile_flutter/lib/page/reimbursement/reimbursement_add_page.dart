...
//
// class ReimbursementAddPage extends StatefulWidget {
//   final Map params;
//   String id;
//
//   ReimbursementAddPage({Key key, this.params}) : super(key: key) {
//     id = params['id'];
//   }
//
//   @override
//   _ReimbursementAddPageState createState() => _ReimbursementAddPageState();
// }
//
// class _ReimbursementAddPageState extends HiState<ReimbursementAddPage> {
...
//   String cname; // 保销人姓名
//   String userId; // 保销人id
//   String repairDate; // 报销日期
//   String repairStatus; // 报销状态
//   String deptName; // 报销部门
//   String deptId; // 报销部门
//   String repairKinds; // 报销种类
//   String repairMer; // 报销物品
//   String tel; // 联系方式
//   String email; // email
//   String repairAddress; // 报销地址
//   String content; // 报销内容
...
//   }
//
//   handleApproves(List<SchoolOaRepairApproveList2> approves) {
...
//       defaultNotices ??= [];
//       if (isEdit) {
//         var result1 = await ReimbursementDao.detail(widget.id);
//         setState(() {
//           model = result1;
...
//       });
//       SysOrgModel rs = await ReimbursementDao.getSysOrg();
//       setState(() {
...
//     }
//
//     return appBar(isEdit ? '报销审批详情' : '报销申请', rightTitle: rightTitle, rightButtonClick: () {
//       if (rightTitle == '删除') {
//         delete();
//       }
//     });
...
//     try {
//       EasyLoading.show(status: '加载中...');
//       var result = await ReimbursementDao.delete(widget.id);
...
//     // unFocus();
//     FocusManager.instance.primaryFocus?.unfocus();
//     List<String> list = ['一般报销申请', '特殊报销申请'];
//     showListDialog(context, title: '请选择报销种类', list: list,
//         onItemClick: (String type, int index) {
//       setState(() {
//         if (model != null && model.schoolOaRepair != null) {
...
//                   initialValue: model != null && model.accessoryList != null ? model.schoolOaRepair.content : '',
//                   minLines: 5,
//                   maxLines: 5,
//                   onChanged: (text) {
//                     content = text;
...
//   _buildAttach() {
//     // unFocus();
//     return SelectAttach(attachs: model?.toAttachList(), itemsCallBack: (List<LocalFile> items) {
//       print("items: ${items}");
//       files = items ?? [];
//     });
//   }
...
//     if (isEmpty(cname)) {
//       showWarnToast("报销人不能为空");
//       return;
//     }
//
//     if (isEmpty(deptName)) {
//       showWarnToast("报销部门不能为空");
//       return;
//     }
//
//     if (isEmpty(repairKinds)) {
//       showWarnToast("请选择报销种类");
//       return;
//     }
//
//     if (isEmpty(repairMer)) {
//       showWarnToast("报销物品不能为空");
//       return;
//     }
//
//     if (isEmpty(tel)) {
...
//       if (isEdit && model.accessoryList != null && model.accessoryList.isNotEmpty) {
//         for (var item in model.accessoryList) {
