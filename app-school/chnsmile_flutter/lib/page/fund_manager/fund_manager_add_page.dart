...
class FundManagerAddPage extends StatefulWidget {
  final Map params;
  String id;

  FundManagerAddPage({Key key, this.params}) : super(key: key) {
    id = params['id'];
  }

  @override
  _FundManagerAddPageState createState() => _FundManagerAddPageState();
}

class _FundManagerAddPageState extends HiState<FundManagerAddPage> {
  ...
  _buildAppBar() {
    ...
    return appBar(isEdit ? '经费审批详情' : '经费申请', rightTitle: rightTitle,
        rightButtonClick: () {
      if (rightTitle == '删除') {
        delete();
      }
