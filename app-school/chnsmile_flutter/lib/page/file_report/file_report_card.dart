...
class FileReportCard extends StatelessWidget {
  final FileReport item;
  final ValueChanged<FileReport> onCellClick;
  final String type;

  const FileReportCard({Key key, this.item, this.onCellClick, this.type})
      : super(key: key);
