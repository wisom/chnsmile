...
class OAFundManagerApproveDialog extends Dialog {
  ...
  OAFundManagerApproveDialog({this.onLeftPress, this.onRightPress, this.onClosePress, this.maxLength = 0, this.titleTip = '审批', this.tipContent = '请输入审批内容', this.isShowBottomContent = true});
