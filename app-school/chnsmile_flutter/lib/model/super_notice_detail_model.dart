import 'package:chnsmile_flutter/model/super_notice_accessory_param.dart';

class SuperNoticeDetailModel {
  String id;
  String formId;
  String title;
  String content;
  ...
  String createName;
  String createTime;
  List<SuperNoticeAccessoryParam> infoDowmAccessoryList;
  List<InfoDownNotice> infoDownNoticeList;

  SuperNoticeDetailModel({
    this.id,
    this.formId,
    this.title,
    this.content,
    ...
    this.createName,
    this.createTime,
    this.infoDowmAccessoryList,
    this.infoDownNoticeList
  });

  SuperNoticeDetailModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    formId = json['formId'];
    title = json['title'];
    ...
    if (json['infoDowmAccessoryList'] != null) {
      infoDowmAccessoryList = new List<SuperNoticeAccessoryParam>();
      json['infoDowmAccessoryList'].forEach((v) {
        infoDowmAccessoryList.add(new SuperNoticeAccessoryParam.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.infoDowmAccessoryList != null) {
      data['infoDowmAccessoryList'] =
          this.infoDowmAccessoryList.map((v) => v.toJson()).toList();
    }
...
class InfoDownNotice {
  ...
  int sort;
  int status;
  List<SuperNoticeAccessoryParam> dowmNoticeAccessoryList;
  ...
  InfoDownNotice.fromJson(Map<String, dynamic> json) {
    ...
    if (json['dowmNoticeAccessoryList'] != null) {
      dowmNoticeAccessoryList = new List<SuperNoticeAccessoryParam>();
      json['dowmNoticeAccessoryList'].forEach((v) {
        dowmNoticeAccessoryList.add(new SuperNoticeAccessoryParam.fromJson(v));
      });
    }
  }
